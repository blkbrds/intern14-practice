...
class Bai4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        emailButton = ButtonView(frame: CGRect(x: 130, y: 200, width: 150, height: 100), value: 5, badgePosition: .topLeft)
        ...
        friendButton = ButtonView(frame: CGRect(x: 130, y: 330, width: 150, height: 100), value: 46, badgePosition: .centerRight)
        ...
        photoButton = ButtonView(frame: CGRect(x: 130, y: 460, width: 150, height: 100), value: 100, badgePosition: .bottomCenter)
