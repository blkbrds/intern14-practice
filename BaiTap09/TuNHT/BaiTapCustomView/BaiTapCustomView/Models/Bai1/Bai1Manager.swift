...
class Bai1Manager {
    let filePath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true)[0].appending("/Bai1ListUsers.plist")
    let nameFile = "ListUsers"
    ...
    func saveDataToDocument(_ data: [Bai1UserData]) -> Bool {
