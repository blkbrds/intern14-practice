...
final class Bai4ViewController: UIViewController {
    override func viewDidLoad() {
        ...
        let emailButton = MyButton(frame: CGRect(x: xButton, y: 200, width: 150, height: 80), badgeNumber: 999, badgePosition: .bottomRight)
        ...
        let friendsButton = MyButton(frame: CGRect(x: xButton, y: 300, width: 150, height: 80), badgeNumber: 99, badgePosition: .bottomLeft)
        ...
        let photosButton = MyButton(frame: CGRect(x: xButton, y: 400, width: 150, height: 80), badgeNumber: 9, badgePosition: .bottomCenter)
