...
func calculate(a1: Double, b1: Double, c1: Double, a2: Double, b2: Double, c2: Double) -> equations {
    let d = a1 * b2 - a2 * b1
    let dx = c1 * b2 - c2 * b1
    let dy = a1 * c2 - a2 * c1
    if d == 0 && c1 == c2 && c1 == 0 {
...
switch calculate(a1: 1, b1: 3, c1: 2, a2: 4, b2: 12, c2: 2) {
case .noResult:
...
print("Array has been replaced to \(arrayReplace(inputArray, 1, 3))")
