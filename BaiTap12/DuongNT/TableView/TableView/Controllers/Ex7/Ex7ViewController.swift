...
class Ex7ViewController: BaseViewController {
    ...
    override func setupUI() {
        ...
        tableView.register(UINib(nibName: "Ex7TableViewCell", bundle: nil), forCellReuseIdentifier: "cell")
...
extension Ex7ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as? Ex7TableViewCell
