...
class Ex05: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //    }
        //    func addColumn(frame: CGRect) -> UIView {
    ...
    func setupBoard() {
        ...
        //        let a = UILabel()
        //        a.frame.origin = CGPoint(x: 0, y: 150)
        //        a.frame.size = CGSize(width: 20, height: 12)
        //        a.text = "aa"
        ...
        for i in 0..<6 {
            ...
            soldValue.text = "\(b)"
            //            soldValue.textAlignment = .center
